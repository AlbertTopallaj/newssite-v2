...
function renderArticles() {
  ...
  articles.reverse().forEach((article) => {
    ...
    card.className =
      "relative flex flex-col gap-1 py-6 px-4 md:px-0 border-b border-gray-200 cursor-pointer group transition-all duration-150 hover:bg-gray-50 hover:px-3 hover:rounded-md hover:border-transparent";
    ...
    if (article.latestnew) {
      ...
      tag.className =
        "text-[11px] font-semibold tracking-wider uppercase px-2 py-0.5 rounded bg-red-100 text-red-800";
      topRow.append(tag);
    }
